...
import { projectGetAllByOrganisation } from "../../../http";
import { Loading, NavigationBar } from "../../../components";

import type { NextPage } from "next";
import type { AxiosResponse } from "axios";

const ProjectsByOrganisation: NextPage = ({ query }: any) => {
    ...
    const { isLoading } = useQuery(["projects", "organisation", organisationId], () => projectGetAllByOrganisation(organisationId as string), {
        ...
        <>
            <div className="relative min-h-screen lg:flex">
                ...
                <div className="flex-1 p-5 md:pt-10 max-h-screen overflow-y-auto">
                    ...
                    {projects && (
                        <>
                            <section className="w-full bg-gray-200 rounded text-xl md:text-3xl text-black font-bold my-4 p-5">Projects By Organisation</section>
