            ...
            <div className="flex items-center justify-center min-h-screen bg-blue-700">
                <div className="container">
                    <div className="text-white text-center">
                        ...
                        <Link href="/" passHref>
                            <button className="bg-gray-200 hover:bg-white mt-4 py-3 px-5 text-sm shadow-sm font-medium tracking-wider text-black rounded-full hover:shadow-lg">Go Home</button>
                        </Link>
                    </div>
                </div>
            </div>
