...
const CreateHashtag: NextPage = () => {
    ...
    const { isLoading: isCreatingHashtag, mutate: createHashtag } = useMutation(hashtagCreate, {
        onSuccess: (response: AxiosResponse) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        createHashtag(formDataToJSON);
    };

    return (
        <>
            <Head>
                <title>Create Hashtag - Haikoto</title>
            </Head>
...
export default withAuth(CreateHashtag);
